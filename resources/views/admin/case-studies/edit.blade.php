        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 md:grid">
                    <form action="{{ route('admin.case-studies.update', $caseStudies->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <x-input id="title" label="Judul" name="title" required :value="$caseStudies->title"/>
                        ...
                        <x-input-file id="image" name="image" label="Gambar" value="{{ $caseStudies->image }}"
