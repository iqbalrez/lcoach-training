<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 xl:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 xl:-my-px xl:ms-10 xl:flex">
                    ...
                    <x-nav-link :href="route('admin.meeting-request.index')" :active="request()->routeIs('admin.meeting-request.*')">
                        {{ __('Meeting Request') }}
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden xl:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('admin.meeting-request.index')" :active="request()->routeIs('admin.meeting-request.*')">
                {{ __('Meeting Request') }}
            </x-responsive-nav-link>
